...
"").split("/"),l="http://www.youtube.com/watch?v="+l[l.length-1],m={time:k.getTime(),date:r,title:b.snippet.title,txt:b.snippet.description.replace(/\n/g,"<br/>").replace(w,'<a href="$1">$1</a>'),link:l,s_link:l,img:m}):m={};break;case "pinterest":k=new Date(b.publishedDate);m=B(b.content,h,t,"","a:first-child",!0);m={time:k.getTime(),date:b.publishedDate,title:"",txt:m.txt,link:b.link,s_link:b.link,img:m.img.replace("/192x/","/550x/")};break;case "soundcloud":k=new Date(b.created_at);r="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/"+
b.id+"&auto_play=true&hide_related=true&visual=true";m=b.artwork_url?b.artwork_url.replace("-large.","-t500x500."):b.user.avatar_url?b.user.avatar_url.replace("-large.","-t500x500."):"";m={time:k.getTime(),date:b.created_at,title:b.title,txt:b.description.replace(/\n/g,"<br/>").replace(w,'<a href="$1">$1</a>'),link:r,s_link:b.permalink_url,img:m};break;case "tumblr":"photo"!=b.type&&"link"!=b.type&&"text"!=b.type?m={}:("photo"==b.type?(k="",l=b.short_url,m=B(e.trim(b.caption),"foo",t,g.src[a].strip_tags,
g.src[a].remove_tags,!0),r=m.txt,m=h?h:b.photos[0].original_size.url,t&&(m=z(m,t.w,t.h))):("link"==b.type?(k=b.title,l=b.url,m=B(e.trim(b.description),h,t,g.src[a].strip_tags,g.src[a].remove_tags,!0)):(k=b.title,l=b.short_url,m=B(e.trim(b.body),h,t,g.src[a].strip_tags,g.src[a].remove_tags,!0)),r=m.txt,m=m.img),v=1E3*b.timestamp,m={time:v,date:new Date(v),title:k,txt:r,link:l,s_link:"link"==b.type?b.short_url:l,img:m});break;default:h||"undefined"==typeof b.mediaGroups||"undefined"==typeof b.mediaGroups[0].contents||
"undefined"==typeof b.mediaGroups[0].contents[0].thumbnails||"undefined"==typeof b.mediaGroups[0].contents[0].thumbnails[0].url||(h=b.mediaGroups[0].contents[0].thumbnails[0].url,l=!0),r=E(b.publishedDate),k=new Date(r),m=B(e.trim(b.content),h,t,g.src[a].strip_tags,g.src[a].remove_tags,!0),m={time:k.getTime(),date:r,title:b.title,txt:m.txt,link:b.link,s_link:b.link,img:m.img},"undefined"!=typeof l&&(h=!1)}if(-1!=q.indexOf("title")||-1!=g.hide_elements.indexOf("title"))m.title="";-1!=q.indexOf("link")&&
(m.link="");-1!=q.indexOf("image")&&(m.img="");m.type=c;m.link_target=f.link_target;m.author="undefined"==typeof f.author?!1:f.author;k="undefined"!=typeof f.exp_img_manag?f.exp_img_manag:{};m.exp_img_pos="undefined"!=typeof k.pos?k.pos:!1;m.exp_img_w="undefined"!=typeof k.w?k.w:!1;m.exp_img_h="undefined"!=typeof k.h?k.h:!1;"undefined"!=typeof f.self_s_link&&f.self_s_link&&(m.s_link=location.href);"undefined"!=typeof m.txt&&""!=m.txt&&n.lcnb_news_array.push(m);if(n.lcnb_news_array.length-n.lcnb_inline_news_count==
g.max_news*(n.lcnb_done_fetches+1))return!1});n.lcnb_done_fetches+=1;n.lcnb_done_fetches==g.src.length&&G(k)}})},B=function(a,c,b,d,f,q){-1!=a.indexOf("<img")&&(a="undefined"!=typeof f&&-1!==f.indexOf("img")&&-1===f.indexOf("img:first")?z(a,b,!0):z(a,b));var h=e("<div />");"undefined"!=typeof q&&q&&(a=a.replace(/\n/g,"<br/>"));h.append('<div id="lcnb_util" style="display: none !important;">'+a+"</div>");!c&&0<h.find("#lcnb_util img").size()?(a=h.find("#lcnb_util img").first().attr("fake-src"),h.find("#lcnb_util img").first().remove()):
a=b?z(c,b.w,b.h):c;"undefined"!=typeof f&&f&&0<e.trim(f).length&&(f=f.split(","),e.each(f,function(a,b){h.find("#lcnb_util "+b).remove()}));"all"==d?h.find("#lcnb_util *").not("p, br, iframe").each(function(){var a=e(this).contents();e(this).replaceWith(a)}):"undefined"!=typeof d&&d&&0<e.trim(d).length&&(d=d.split(","),e.each(d,function(a,b){h.find("#lcnb_util "+b).each(function(){var a=e(this).contents();e(this).replaceWith(a)})}));h.find("#lcnb_util *").removeAttr("style");h.find("*:empty").not("br, img, i").remove();
for(x=0;2>x;x++)h.find(".lcnb_txt > *:first").is("br")&&h.find(".lcnb_txt > *:first").remove(),h.find("br").each(function(){e(this).prev().is("p")&&e(this).remove()});d=e.trim(h.find("#lcnb_util").html());return{txt:e.trim(d),img:a}},z=function(a,c,b){if(!a)return a;e.makeArray();var d=e("<div />");d.append('<div id="lcnb_fake_util" style="display: none !important;">'+a+"</div>");d.find("img").wrap("<span></span>");a=d.find("#lcnb_fake_util").html();d.html('<div id="lcnb_fake_util" style="display: none !important;">'+
a.replace(/<img/g,"<fake-img")+"</div>");d.find("fake-img").each(function(){var a=e(this).attr("src");"undefined"!=typeof a&&-1!=a.indexOf("safe_image.php")&&(a=D(a,"url"));e('<img fake-src="'+a+'" />').insertBefore(this);e(this).remove()});"undefined"==typeof b&&c&&d.find("img").each(function(){var a=e(this).attr("fake-src"),a=lcnb_script_basepath+"php_assets/img_size_check.php?src="+encodeURIComponent(a)+"&max_w="+c.w+"&max_h="+c.h;e(this).attr("fake-src",a)});return d.find("#lcnb_fake_util").html()},
V=function(a,c,b){return parseInt(c)&&parseInt(b)?lcnb_script_basepath+"php_assets/img_size_check.php?src="+encodeURIComponent(a)+"&max_w="+c+"&max_h="+b:a},G=function(a){var c=a.data("lcnb_vars");if(c.lcnb_ordered_news.length==g.max_news||0==c.lcnb_news_array.length)return c.lcnb_news_number=c.lcnb_ordered_news.length,W(),!0;var b=0,d=0;e.each(c.lcnb_news_array,function(a,c){c.time>d&&(b=a,d=c.time)});c.lcnb_ordered_news.push(c.lcnb_news_array[b]);c.lcnb_news_array.splice(b,1);G(a)},W=function(){g.news_per_time>
n.lcnb_news_number&&(g.news_per_time=n.lcnb_news_number);e.each(n.lcnb_ordered_news,function(a,c){var b=1==g.social_share?O(c.type,c):"";if("undefined"!=typeof c.link&&""!=c.link)var d="soundcloud"==c.type?c.s_link:c.link,f='<div class="lcnb_link"><a href="'+d+'" target="_blank"></a></div>';else f="","link"==g.title_behavior&&(g.title_behavior="none"),"link"==g.img_behavior&&(g.img_behavior="none");var e=-1==g.hide_elements.indexOf("date")?'<div class="lcnb_btn_time" '+(g.read_more_btn?'style="display: none;"':
"")+'><time class="lcnb_date" pubdate="pubdate" datetime="'+c.date+'">'+P(c.date)+"</time></div>":"";if(g.read_more_btn&&"undefined"!=typeof c.link&&""!=c.link)var h='<div class="lcnb_btn_time lcnb_rm_btn_wrap"><a class="lcnb_rm_btn" href="'+d+'">'+g.read_more_btn_txt+"</a></div>",f="";else h="";if(1==g.expandable_news)var t='<div class="lcnb_btn_expand noSwipe"></div>';else t="","expand"==g.title_behavior&&(g.title_behavior="none"),"expand"==g.img_behavior&&(g.img_behavior="none");var l="",r="",
v="";if(-1==g.hide_elements.indexOf("btn_bar"))if("side"==g.buttons_position&&"vertical"==g.layout&&g.boxed_news){if(1==g.social_share||f||-1==g.hide_elements.indexOf("date"))l='<div class="lcnb_buttons noSwipe" style="position: '+(1!=g.btn_over_img||"undefined"==typeof c.img||""==c.img?"relative":"absolute")+';">'+t+f+b+"</div>";if(-1==g.hide_elements.indexOf("date")||h)v='<div class="lcnb_btm_bar">'+e+h+"</div>"}else if("top"==g.buttons_position){if(1==g.social_share||f||-1==g.hide_elements.indexOf("date")||
h)r='<div class="lcnb_top_bar">'+t+b+f+e+h+"</div>"}else if(1==g.social_share||f||-1==g.hide_elements.indexOf("date")||h)v='<div class="lcnb_btm_bar">'+t+b+f+e+h+"</div>";f=""==c.title?"":"link"==g.title_behavior?'<h3 class="lcnb_title"><a href="'+d+'" class="lcnb_linked_title">'+c.title+"</a></h3>":'<h3 class="lcnb_title '+("expand"==g.title_behavior?"lcnb_expand_trig noSwipe":"")+'">'+c.title+"</h3>";b="undefined"==typeof c.author||""==c.author?"":'<span class="lcnb_author">'+c.author+"</span> ";
"none"!=g.img_behavior?(e="youtube"==c.type||"soundcloud"==c.type?"lcnb_video_lb":"lcnb_img_lb","inline"==c.type&&"undefined"!=typeof c.video&&(e="lcnb_video_lb"),"expand"==g.img_behavior&&g.expandable_news&&(e+=" lcnb_expand_trig"),"link"==g.img_behavior&&(e+=" lcnb_linked_img"),d=(h="youtube"==c.type?c.s_link:"soundcloud"==c.type?c.link:"inline"==c.type&&"undefined"!=typeof c.video?c.video:D(c.img,"src"))?'<div class="'+e+' noSwipe" data-mfp-src="'+h+'"><div class="lcnb_lb_icon">'+("link"==g.img_behavior?
'<a href="'+d+'"></a>':"")+'</div><div class="lcnb_lb_overlay"></div></div>':""):d="";e=(d="undefined"==typeof c.img||""==c.img?"":'<div class="lcnb_img"><div><img src="'+c.img+'"/></div>'+d+"</div>")&&"horizontal"==g.layout&&g.horiz_img_mode?"lcnb_h_img_mode":"";l='<article class="lcnb_news lcnb_type_'+c.type+" "+e+" "+(e&&!f?"lcnb_him_no_txt":"")+'" style="opacity: 0; filter: alpha(opacity=0); top: 30px;" rel="'+a+'"><div class="lcnb_news_inner">'+l+d+r+('<section class="lcnb_contents"><div><div class="lcnb_contents_inner">'+
f+' <div class="lcnb_txt">'+b+("undefined"!=typeof c.excerpt&&c.excerpt?c.excerpt:c.txt)+"</div></div></div></section>")+v+"</div></article>";k.find(".lcnb_inner").append(l);n.lcnb_excerpts[a]="undefined"!=typeof c.excerpt?c.excerpt:"";n.lcnb_orig_texts[a]=b+c.txt;"undefined"!=typeof c.link_target&&c.link_target&&k.find(".lcnb_news:last-child a").attr("target",c.link_target);a==n.lcnb_news_number-1&&(A(),H(),X(),Q(),g.touchswipe&&I())})},X=function(){k.find(".lcnb_wrap").removeClass("lcnb_loading");
var a=k.data("lcnb_vars");k.find(".lcnb_news").each(function(c,b){c+1>a.lcnb_news_to_show&&(c=0);var d=e(this);setTimeout(function(){d.animate({opacity:1,top:0},550)},300*c)});500>e(window).width()&&setTimeout(function(){A()},200);g.autoplay&&!1===a.lcnb_is_playing&&J(k)},E=function(a){if(-1!=navigator.appVersion.indexOf("MSIE")){if(-1!=a.indexOf("Z")||-1!=a.indexOf("T")){var c=/(\d\d\d\d)(-)?(\d\d)(-)?(\d\d)(T)?(\d\d)(:)?(\d\d)(:)?(\d\d)(\.\d+)?(Z|([+-])(\d\d)(:)?(\d\d))/,b=new Date;a.toString().match(new RegExp(c))?
(a=a.match(new RegExp(c)),c=0,b.setUTCDate(1),b.setUTCFullYear(parseInt(a[1],10)),b.setUTCMonth(parseInt(a[3],10)-1),b.setUTCDate(parseInt(a[5],10)),b.setUTCHours(parseInt(a[7],10)),b.setUTCMinutes(parseInt(a[9],10)),b.setUTCSeconds(parseInt(a[11],10)),a[12]?b.setUTCMilliseconds(1E3*parseFloat(a[12])):b.setUTCMilliseconds(0),"Z"!=a[13]&&(c=60*a[15]+parseInt(a[17],10),c*="-"==a[14]?-1:1,b.setTime(b.getTime()-6E4*c))):b.setTime(Date.parse(a));return b}if(isNaN(new Date(a)))return b=a.split(" "),new Date(Date.parse(b[1]+
" "+b[2]+", "+b[5]+" "+b[3]+" UTC"))}return a},P=function(a){var c=new Date(a);if(g.elapsed_time)a=Math.ceil(((new Date).getTime()-c.getTime())/1E3),60>a?a=a+" "+g.elapsed_names[1]:60<=a&&120>a?a="1 "+g.elapsed_names[2]:3600>a?(a=Math.floor(a/60),a=a+" "+g.elapsed_names[3]):3600<=a&&7200>a?a="1 "+g.elapsed_names[4]:86400>a?(a=Math.floor(a/60/60),a=a+" "+g.elapsed_names[5]):86400<=a&&172800>a?a="1 "+g.elapsed_names[6]:604800>a?(a=Math.floor(a/60/60/24),a=a+" "+g.elapsed_names[7]):604800<=a&&1209600>
a?a="1 "+g.elapsed_names[8]:2592E3>a?(a=Math.floor(a/60/60/24/7),a=a+" "+g.elapsed_names[9]):2592E3<=a&&5184E3>a?a="1 "+g.elapsed_names[10]:(a=Math.floor(a/60/60/24/30),a=a+" "+g.elapsed_names[11]),a=a+" "+g.elapsed_names[0];else{a=g.date_format;var b="";-1<a.indexOf("SS")&&(b=10>c.getSeconds()?"0":"",a=a.replace("SS",b+c.getSeconds()));-1<a.indexOf("MM")&&(b=10>c.getMinutes()?"0":"",a=a.replace("MM",b+c.getMinutes()));-1<a.indexOf("HHH")?(b=12<=c.getHours()?"PM":"AM",a=a.replace("HHH",c.getHours()%
12+" "+b)):-1<a.indexOf("HH")?(b=10>c.getHours()?"0":"",a=a.replace("HH",b+c.getHours())):-1<a.indexOf("H")&&(a=a.replace("H",c.getHours()));-1<a.indexOf("dddd")?a=a.replace("dddd",g.full_d_names[c.getDay()]):-1<a.indexOf("ddd")?a=a.replace("ddd",g.short_d_names[c.getDay()]):-1<a.indexOf("dd")?(b=10>c.getDate()?"0":"",a=a.replace("dd",b+c.getDate())):-1<a.indexOf("d")&&(a=a=a.replace("d",c.getDate()));-1<a.indexOf("mmmm")?a=a.replace("mmmm",g.full_m_names[c.getMonth()]):-1<a.indexOf("mmm")?a=a.replace("mmm",
g.short_m_names[c.getMonth()]):-1<a.indexOf("mm")?(b=10>c.getMonth()+1?"0":"",a=a.replace("mm",b+(c.getMonth()+1))):-1<a.indexOf("m")&&(a=a.replace("m",c.getMonth()+1));-1<a.indexOf("yyyy")?a=a.replace("yyyy",c.getFullYear()):-1<a.indexOf("yy")&&(c=c.getFullYear().toString(),a=a.replace("yy",c.substr(2)))}return a},A=function(a){var c=k.data("lcnb_settings"),b=k.data("lcnb_vars"),d=k.find(".lcnb_wrap"),f=d.find(".lcnb_news"),q="undefined"==typeof a?c.news_per_time:a;k.find(".lcnb_news").size()<=q?
k.find(".lcnb_wrap").removeClass("lcnb_has_cmd"):0<k.find(".lcnb_cmd").size()&&k.find(".lcnb_wrap").addClass("lcnb_has_cmd");var h=d.hasClass("lcnb_uniblock")?d.hasClass("lcnb_horizontal")?-1*l(d.find(".lcnb_news").last().css("border-left-width")):-1*l(d.find(".lcnb_news").last().css("border-top-width")):0;d.css("width","");if(d.hasClass("lcnb_uniblock")){a=d.width()-l(d.css("border-left-width"))-l(d.css("border-right-width"))+h;var g=c.height-l(d.css("border-top-width"))-l(d.css("border-bottom-width"))+
h}else a=d.width(),g=c.height;if(d.hasClass("lcnb_horizontal")){a=a/q-l(f.css("margin-left"))-l(f.css("margin-right"));d.hasClass("lcnb_uniblock")&&(a=a+l(f.css("border-right-width"))-l(f.css("border-left-width"))-h);if(a<c.min_news_w&&1<q)return A(q-1),!1;a=Math.floor(a);var w=d.height()-l(f.css("margin-top"))-l(f.css("margin-bottom")),g=q*(a+l(f.css("margin-left"))+l(f.css("margin-right")));d.hasClass("lcnb_uniblock")&&(g=g+q*h-h);h=d.width()+l(d.css("border-top-width"))+l(d.css("border-bottom-width"));
h<g&&d.css("margin-right",l(d.css("margin-right"))-1);h>g&&d.css("margin-right",l(d.css("margin-right"))+1);b.lcnb_news_w=a;b.lcnb_news_h=w;b.lcnb_news_to_show=q;d.hasClass("lcnb_uniblock")&&(b=d.width()-(a*q-(q-1)*l(f.css("border-left-width"))),0!=b&&d.css("width",d.width()-b));"top"==c.buttons_position&&d.find(".lcnb_contents_inner").removeAttr("style")}else{g=g/q-l(f.css("margin-top"))-l(f.css("margin-bottom"));d.hasClass("lcnb_uniblock")&&(g=g+l(f.css("border-bottom-width"))-l(f.css("border-top-width"))-
h);if(g<c.min_news_h&&1<q)return A(q-1),!1;w=Math.round(g);a=a-l(f.css("margin-left"))-l(f.css("margin-right"));d.hasClass("lcnb_uniblock")&&(a-=h);g=q*(w+l(f.css("margin-top"))+l(f.css("margin-bottom")));d.hasClass("lcnb_uniblock")&&(g=g+q*h-h);h=c.height+l(d.css("border-top-width"))+l(d.css("border-bottom-width"));b.lcnb_is_expanded||(h<g?d.css("height",g):d.css("height",c.height));b.lcnb_news_w=100;b.lcnb_news_h=w;b.lcnb_news_to_show=q}d.hasClass("lcnb_horizontal")?(f.find(".lcnb_contents").css("max-height",
